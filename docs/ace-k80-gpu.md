...
> **OpenClaw / ai.prestonhager.com:** TEMPORARILY DISABLED (2026-07-12). Ollama is also off until the NVIDIA driver loads successfully (`enableOllama = false`). See [ace-openclaw-sso.md](./ace-openclaw-sso.md).
