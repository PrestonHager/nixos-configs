...
{
  # Merge the full CA chain with the root certificate that issued it to allow
  # Portunus to use TLS on the LDAP server.
#  security.acme = {
#    acceptTerms = true;
...
#  };
  ...
  services.caddy = {
    virtualHosts."portunus.prestonhager.com".extraConfig = ''
