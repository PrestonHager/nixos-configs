...
return [
	'routes' => [
		...
		['name' => 'api#cancelMigration', 'url' => '/api/migrate/{id}/cancel', 'verb' => 'POST'],
		['name' => 'api#pauseMigration', 'url' => '/api/migrate/{id}/pause', 'verb' => 'POST'],
		['name' => 'api#resumeMigration', 'url' => '/api/migrate/{id}/resume', 'verb' => 'POST'],
